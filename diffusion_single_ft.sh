...
OUTPUT_DIR="./logs/jjanggu6"
DELTA_CKPT="./logs/jjanggu6/delta.bin"
...
## launch training script (2 GPUs recommended, increase --max_train_steps to 500 if 1 GPU)
MODEL_NAME="CompVis/stable-diffusion-v1-4"
OUTPUT_DIR="./logs/jjanggu7"
DELTA_CKPT="./logs/jjanggu7/delta.bin"
FROM_FILE="./prompts/jjanggu.txt"
KEYWORD="base_setting"
...
accelerate launch src/diffusers_training.py \
          ...
          --output_dir ${OUTPUT_DIR}  \
          --with_prior_preservation --real_prior --prior_loss_weight=1.0 \
          --instance_prompt="image of a <new1> boy character"  \
          --class_prompt="boy character" \
          --resolution=512  \
          --train_batch_size=2  \
          --learning_rate=1e-5  \
          --lr_warmup_steps=0 \
